...
export const PANDUAN_BABS: PanduanBab[] = [
  ...
  { slug: 'dashboard', file: '04-dashboard.md', title: '4. Dashboard', desc: 'Header, KPI & grafik', icon: 'i-lucide-chart-column', order: 4 },
  ...
  { slug: 'arsip', file: '08-arsip.md', title: '8. Arsip', desc: 'Retensi, toolbar & pemusnahan', icon: 'i-lucide-archive', order: 8 },
