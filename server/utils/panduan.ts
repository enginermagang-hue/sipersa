...
export const PANDUAN_BABS: PanduanBab[] = [
  ...
  { slug: 'dashboard', file: '04-dashboard.md', title: '4. Dashboard', desc: 'Header responsive, KPI & Aksi Cepat (hidden pimpinan)', icon: 'i-lucide-chart-column', order: 4 },
  ...
  { slug: 'arsip', file: '08-arsip.md', title: '8. Arsip', desc: 'Retensi via /api/arsip/stats, toolbar 1 baris & pemusnahan', icon: 'i-lucide-archive', order: 8 },
  { slug: 'laporan', file: '09-laporan.md', title: '9. Laporan', desc: 'Hanya admin & staff — Filter, KPI & export', icon: 'i-lucide-file-bar-chart', order: 9 },
  { slug: 'pencarian', file: '10-pencarian.md', title: '10. Pencarian Global', desc: 'Cari surat & arsip lintas modul — calendar range picker', icon: 'i-lucide-search', order: 10 },
