...
<template>
  <UCard>
    <template #header>
      <div class="flex justify-between items-center"><span class="font-semibold">Tren Surat</span>
        <UFieldGroup size="xs">
          <UButton :variant="type === 'line' ? 'solid' : 'outline'" @click="type = 'line'">Line</UButton>
          <UButton :variant="type === 'bar' ? 'solid' : 'outline'" @click="type = 'bar'">Bar</UButton>
        </UFieldGroup>
      </div>
    </template>
