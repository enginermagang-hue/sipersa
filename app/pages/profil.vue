...
const canUploadTtd = computed(() => user.value?.role === 'pimpinan' || user.value?.role === 'staff')
      ...
      <div class="lg:col-span-5 space-y-4">
        ...
        <UCard class="rounded-xl">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <UButton v-if="user?.role === 'staff'" to="/surat-keluar" variant="outline" class="justify-start h-auto py-2.5 px-3" icon="i-lucide-file-plus">
              <div class="text-left">
